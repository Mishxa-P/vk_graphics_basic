...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, { 0, 0, m_width * (m_ssaa ? 2 : 1), m_height * (m_ssaa ? 2 : 1) },
  ...
  blit.srcOffsets[1]                 = { int32_t(m_width * (m_ssaa ? 2 : 1)), int32_t(m_height * (m_ssaa ? 2 : 1)), 1 };
